...
- 六個附錄 = references/*.md(各自降級成「附錄N」標題)
...
APPENDICES = [
    ...
    ("civil-petition.md", "五"),
    ("official-scenarios.md", "六"),
]

FRONTMATTER = """---
name: tw-formal-writing-standalone
description: >
  台灣正式文件撰寫助手（獨立單檔版本，適用於 ChatGPT / Gemini）— 涵蓋政府公文、政府機關其他文件、法律文件、人民對政府文書四類中文正式文件的撰寫（不含學術論文、商業文書、私人書信等，見下方排除清單）。
  ...
  - 政府機關其他文件：會議紀錄、開會通知單、新聞稿、聲明稿、施政報告、出國報告、施政計畫書、業務計畫書、裁處書、訴願決定書、聘函、獎狀、證書
  - 法律文件：存證信函、律師函、合約書、備忘錄(MOU)、保密協議(NDA)、聲明書、切結書、委託書、授權書
  - 人民對政府文書：陳情書、申請書、訴願書、異議書、申覆書
  - 描述需要撰寫正式文件的情境（如「幫我寫一封給教育部的公文」「我要寄存證信函」「幫我寫陳情書」）
  - 詢問任何正式文件的格式或用語規範
  - 公務員考試或受訓的公文練習題
  - 公文案件後續：催辦、展期、補正、否准、陳述意見通知、陳情答復、原函更正、會辦、會勘、會議異動、公務電話紀錄
...
CROSS_REF_FIXES = [
    ("`references/official-scenarios.md`", "附錄六（公文案件場景補充指引）"),
